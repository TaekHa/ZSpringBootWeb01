...
////		  API확인 :: 주석을 풀고 확인하면... //==> 아래의 1을 0으로 변경 해보면... //Assert.assertEquals(1,
//		  userService.addUser(user)); //Assert.assertEquals(1,
//		  userDAO.removeUser(user.getUserId())); Assertions.assertEquals(1,
//		  userService.addUser(user)); Assertions.assertEquals(1,
